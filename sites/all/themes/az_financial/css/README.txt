...
To use these stylesheets, rename the files and az_financial with the name of your theme.
...
az_financial-alpha-default.css
...
az_financial-alpha-default-narrow.css  
...
az_financial-alpha-default-normal.css
...
az_financial-alpha-default-wide.css
