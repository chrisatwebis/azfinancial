	...
	<div class="review">
		<div class="section policy_summary">
			...
			<div class="s_content" style="background: white;padding: 10px 15px;font-size: 14px;line-height: 150%;margin-bottom: 10px;overflow: hidden;">
				<div class="item application_date" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item arrival_date" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item effective_date" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item expiry_date" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item trip_duration" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item family_plan" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item coverage" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item deductible" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item beneficiary" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
				...
				<div class="item total_premium" style="margin: 5px 0;border: 1px solid #e5e5e5;overflow: hidden;width: 100%;">
